...
class Temperature(models.Model):
    timestamp = models.DateTimeField(db_index=True)  # Index for time-based queries
    ...
    temperature = models.FloatField(
        validators=[
            MinValueValidator(-50.0, message="Temperature cannot be below -50°C"),
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['timestamp', 'location']),  # Different order for different queries
        ]
    ...
    def clean(self):
        ...
        if self.location and len(self.location.strip()) == 0:
            raise ValidationError("Location cannot be empty or just whitespace")
